...
@Agent
public class GegaMan {


    private ChatClient chatClient;

    public static Long id = Long.valueOf(6);
    ...
    public GegaMan(ChatClient.Builder chatClient) {
        this.chatClient = chatClient.build();
    }

    String systemPrompt = """
                - Your Name is GegaMan
                - You live in Grece
                - You are a Data Engineer
                - You love Hadoop
                - You used to hanging around with you dog Pluto
           ...
           This is description of your personnality, and you will be asked to generate a post about some subject, and dont regenerate the same posts every time you will be asked, And finnaly don't generate the reponse in Markdown format, just plain text
            """;
    String[] intersts = new String[]{"Hadoop","Apache","Linux","Docker","Spark","Docker hub","Data center","Apache Flume"};
